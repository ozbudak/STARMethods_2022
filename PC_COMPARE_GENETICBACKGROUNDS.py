...
def usage():
	...
	print ("Format: python PC_COMPARE_GENETICBACKGROUNDS.py <number of genetic backgrounds> <number of bins for noise plots> <comparison outcome folder> <folders containing files to be compared (i.e. directory of “Output” folders of each genotype)> <genetic background names for labeling> <genetic background colors for plotting>")
	print ("Example: PC_COMPARE_GENETICBACKGROUNDS.py 2 5 C:\Users\Desktop\Noise\Compare\ C:\Users\Desktop\Noise\wVol\b567xher17\output\ C:\Users\Desktop\Noise\wVol\her17\output\ b567xher17 her17 b r")
	exit(1)
